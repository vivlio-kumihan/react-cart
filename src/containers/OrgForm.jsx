    ...
    <div className="form" onSubmit={onSubmitEmail}>
      ...
      <div className="send-buttons non-print">
        ...
        <div className="send-btn">
          ...
          <div className="note">FAXでのお申込みができない方は、こちらをお選びください。ご記入いただいたメールアドレスにEメールが届きますので、<span className="underLine">届いたEメールに撮影した郵便振込用紙、または明細票を添付のうえご返信ください</span> 。（※メールが届かない場合、迷惑メールフィルターなどご確認ください。）</div>
        </div>
      </div>
